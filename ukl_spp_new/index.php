...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="/ukl_spp_new/Styles/index.css">  
          ...
          <div class="mm-par-wrap">
            <div class="mm-parallax" data-tilt data-tilt-max="4" >
              ...
              if($_SESSION['level'] == "admin"){
                echo "<div class=\"bg\" data-bg=\"https://wallpapercave.com/wp/wp8255146.jpg\" style=\"background-image: url(https://wallpapercave.com/wp/wp8255146.jpg);\">";
                echo "</div>";
