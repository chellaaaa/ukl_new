...
$Connectpath .= "/ukl_spp_new/utils/connect.php";
require($Connectpath);
...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
        <link rel="stylesheet" type="text/css" href="/ukl_spp_new
    /Styles/header.css">        
...
<body>
<div class="all-table"> 
    <h2> <img src="https://wallpaperaccess.com/full/3954357.jpg" alt="pp" style="border-radius: 50%;" width="50px" height="50px"> Hallo, <?= $result['nama']; ?></h2>
    <a href="/ukl_spp_new/login-logout/logout.php"><button class="btn btn-outline-secondary " name="logout">Logout</button></a>
